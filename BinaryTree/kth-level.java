...
public class main1 {
    ...
    public static boolean getpath(Node root, ArrayList<Integer> path, int ans) {
        if(root == null){
            return false;
        }
        ...
        boolean l = getpath(root.left, path, ans);
        boolean r = getpath(root.right, path, ans);  
